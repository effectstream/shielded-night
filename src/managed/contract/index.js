...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_15.alignment().concat(_descriptor_8.alignment().concat(_descriptor_3.alignment().concat(_descriptor_0.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_15.toValue(value_0.domain_sep).concat(_descriptor_8.toValue(value_0.info).concat(_descriptor_3.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data))));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      name: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('name',
                                     ...
                                     'convert-vault.compact line 116 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      symbol: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('symbol',
                                     'argument 1 (as invoked from Typescript)',
                                     'convert-vault.compact line 122 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      decimals: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('decimals',
                                     'argument 1 (as invoked from Typescript)',
                                     'convert-vault.compact line 128 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      tokenColor: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('tokenColor',
                                     'argument 1 (as invoked from Typescript)',
                                     'convert-vault.compact line 134 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      depositUnshielded: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('depositUnshielded',
                                     'argument 1 (as invoked from Typescript)',
                                     'convert-vault.compact line 202 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(secret_0).concat(_descriptor_2.toValue(amount_0)),
      ...
      depositShielded: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('depositShielded',
                                     'argument 1 (as invoked from Typescript)',
                                     'convert-vault.compact line 268 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(secret_0.buffer instanceof ArrayBuffer && secret_0.BYTES_PER_ELEMENT === 1 && secret_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(secret_0).concat(_descriptor_8.toValue(coin_0)),
      ...
      withdrawUnshielded: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('withdrawUnshielded',
                                     'argument 1 (as invoked from Typescript)',
                                     'convert-vault.compact line 300 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(secret_0.buffer instanceof ArrayBuffer && secret_0.BYTES_PER_ELEMENT === 1 && secret_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(secret_0).concat(_descriptor_2.toValue(amount_0).concat(_descriptor_6.toValue(recipient_0))),
            alignment: _descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_6.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      withdrawShielded: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(secret_0).concat(_descriptor_2.toValue(amount_0).concat(_descriptor_7.toValue(recipient_0).concat(_descriptor_0.toValue(nonce_0)))),
            alignment: _descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_7.alignment().concat(_descriptor_0.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(decimals__0) === 'bigint' && decimals__0 >= 0n && decimals__0 <= 255n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 3 (argument 4 as invoked from Typescript)',
                                 'convert-vault.compact line 106 char 1',
                                 'Uint<0..256>',
                                 decimals__0)
    }
  ...
  _creditKey_0(context, partialProofData, balanceKey_0, amount_0) {
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 340282366920938463463374607431768211455n) {
                      throw new __compactRuntime.CompactError('convert-vault.compact line 165 char 31: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 340282366920938463463374607431768211455');
                    }
                    return t1;
  ...
  _depositShielded_0(context, partialProofData, secret_0, coin_0) {
    ...
    __compactRuntime.assert(this._equal_2(c_0.color,
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'convert-vault.compact line 48 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
